...
flags.DEFINE_string(
    "output_dir", 'gs://nq-challenge-bucket/bert_joint/output',
...
flags.DEFINE_string(
    "predict_file", 'gs://nq-challenge-bucket/bert_joint/input/nq-dev-all.jsonl.gz',
    "NQ json for predictions. E.g., dev-v1.1.jsonl.gz or test-v1.1.jsonl.gz")

flags.DEFINE_string(
    "output_prediction_file", 'gs://nq-challenge-bucket/bert_joint/output/predictions.json',
...
flags.DEFINE_bool(
    ...
    "If true, all of the warnings related to input processing will be printed. "
...
def create_example_from_jsonl(line):
  ...
  if annotated_idx in context_idxs:
    ...
    # a bug in the input preparation code above.
...
class InputFeatures(object):
  """A single set of features of input."""
...
class EvalExample(object):
  """Eval input available for a single example."""
...
def compute_predictions(example):
  ...
  if predictions:
    score, summary, start_span, end_span = sorted(predictions,  key=operator.itemgetter(0), reverse=True)[0]
